...
Route::group(['middleware' => ['auth']] , function() {
    ...
    // სტუდენტების რესურსების მართვის კონტროლი
